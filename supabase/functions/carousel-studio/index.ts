    ...
    direcoes: {
      ...
      items: {
        ...
        properties: {
          ...
          layout: {
            type: "string",
            enum: ["estudio", "vidro", "capa", "organico", "agencia", "editorial", "impacto", "revista", "gradiente", "minimal", "foto"],
          },
          fonte: {
            type: "string",
