...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const linkedinRedirectUri = Deno.env.get("LINKEDIN_REDIRECT_URI") ?? "https://caluagencia.com.br/oauth/linkedin";
...
JSON esperado:
{
  ...
  "call_to_action": "LEARN_MORE|SIGN_UP|CONTACT_US|GET_OFFER|BUY_NOW"
    ...
    if (action === "google-ads-oauth-url") {
      ...
      const googleRedirectUri = Deno.env.get("GOOGLE_REDIRECT_URI") ?? "https://caluagencia.com.br/oauth/google";
