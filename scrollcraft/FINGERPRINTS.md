...
| calu-lp-papel (2026-09-08, substitui a noite editorial em produção) | Redação em papel: página clara, serif editorial, objetos impressos (pauta do dia, calendário de parede, lista de aprovação), marca-texto limão como gesto | Barra em papel com botão de tinta retangular; menu de tela cheia em serif | Título serif em duas linhas com marca-texto que passa; à direita, a pauta do dia numa folha inclinada com carimbo, riscada em tempo real | flow (hero), pin 2.6 (o mês em duas folhas), manifesto por palavras, 01 a 06 em linhas finas; 12.2vh desktop | Bloco de tinta cheia com marca-texto no título, e colofão no rodapé | Pauta do dia sendo riscada + marca-texto que passa sobre a palavra que importa | Não fotográfico: papel, tinta, marca-texto, carimbo | React (rota /), motor em /public/scrollcraft, Cloudflare Workers |
