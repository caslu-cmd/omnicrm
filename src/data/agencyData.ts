...
export const CLIENTS: Client[] = [
  {
    ...
    pipeline: [],
    agentTasks: {
      copywriter: { current: "Aguardando briefing", status: "aguardando", recent: [], progress: 0 },
      traffic:    { current: "Aguardando briefing", status: "aguardando", recent: [], progress: 0 },
      analyst:    { current: "Aguardando briefing", status: "aguardando", recent: [], progress: 0 },
      social:     { current: "Aguardando briefing", status: "aguardando", recent: [], progress: 0 },
      strategist: { current: "Aguardando briefing", status: "aguardando", recent: [], progress: 0 },
      sales:      { current: "Aguardando briefing", status: "aguardando", recent: [], progress: 0 },
      designer:   { current: "Aguardando briefing", status: "aguardando", recent: [], progress: 0 },
      site:       { current: "Aguardando briefing", status: "aguardando", recent: [], progress: 0 },
      briefing:   { current: "Aguardando briefing", status: "aguardando", recent: [], progress: 0 },
      revisor:    { current: "Aguardando briefing", status: "aguardando", recent: [], progress: 0 },
      calendario: { current: "Aguardando briefing", status: "aguardando", recent: [], progress: 0 },
      video:      { current: "Aguardando briefing", status: "aguardando", recent: [], progress: 0 },
    },
