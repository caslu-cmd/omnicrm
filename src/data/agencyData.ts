...
export const CLIENTS: Client[] = [];
  ...
  // ── ABCER ────────────────────────────────────────────────────
  {
    ...
    metrics: [
      ...
      { label: "Novos associados", value: "—", change: "—", positive: true },
      { label: "Inscrições evento", value: "—", change: "—", positive: true },
    ],
    orchestratorStatus: "",
    orchestratorPlan: [],
    agentTasks: {
      copywriter: { current: "", status: "idle", recent: [], progress: 0 },
      traffic: { current: "", status: "idle", recent: [], progress: 0 },
      analyst: { current: "", status: "idle", recent: [], progress: 0 },
      social: { current: "", status: "idle", recent: [], progress: 0 },
      strategist: { current: "", status: "idle", recent: [], progress: 0 },
      sales: { current: "", status: "idle", recent: [], progress: 0 },
      designer: { current: "", status: "idle", recent: [], progress: 0 },
      site: { current: "", status: "idle", recent: [], progress: 0 },
      revisor: { current: "", status: "idle", recent: [], progress: 0 },
      video: { current: "", status: "idle", recent: [], progress: 0 },
    },
    contacts: [],
    pipeline: [],
    outputs: [],
