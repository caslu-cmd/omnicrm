      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <motion.div variants={item} className="rounded-xl bg-card border border-border p-5 shadow-card">
            ...
            <div className="space-y-3">
              {topDeals.map((d) => (
                <div key={d.name} onClick={() => navigate("/pipelines")} className="flex items-center justify-between flex-wrap gap-4 p-3 rounded-lg bg-muted/40 cursor-pointer hover:bg-muted/60 transition-colors">
                  <div>
          ...
          <motion.div variants={item} className="rounded-xl bg-card border border-border p-5 shadow-card">
            ...
            <div className="space-y-2.5">
              {upcomingMeetings.map((m) => (
                <div key={m.title} onClick={() => navigate("/scheduling")} className="flex items-center justify-between flex-wrap gap-4 p-2.5 rounded-lg border border-border cursor-pointer hover:bg-muted/30 transition-colors">
                  <div>
