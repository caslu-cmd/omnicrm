...
import {
  ArrowLeft, Instagram, Facebook, Zap, FileText,
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <ArrowLeft className="w-3.5 h-3.5" /> Agência
        </button>
        ...
        <div className="flex items-center gap-2.5">
          <div
            ...
            style={{ background: `${client.color}20`, border: `1px solid ${client.color}35`, color: client.color }}
          >
            {client.initials}
          </div>
        ...
        <div className="ml-auto flex items-center gap-4 text-xs" style={{ color: "rgba(255,255,255,0.35)" }}>
      ...
      {/* ── Tab nav ── */}
      <div
        className="flex gap-1 px-8 flex-shrink-0"
        ...
        {TABS.map((tab) => {
          ...
          return (
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-3.5 text-xs font-medium relative transition-colors"
              style={{ color: isActive ? client.color : "rgba(255,255,255,0.35)" }}
            >
